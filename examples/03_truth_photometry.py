...
容器内运行：
    SC_IMAGE=star-chart:cpu-interim bash scripts/dr.sh python examples/03_truth_photometry.py
...
zp = zero_point_from_truth(track.flux[:len(matched_rows)], truth.mag[matched_rows])
print("--- 星等零点 ---")
